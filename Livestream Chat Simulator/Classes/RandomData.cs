...
namespace Livestream_Chat_Simulator.Classes
{
    ...
    public static class RandomData
    {
        ...
        //S%
        public static List<string> SubjectAreas = new List<string>() { "Tech", "Technology", "Programming" };
        ...
        public static string[] Insults = { "is a complete tool", "sucks", "is annoying", "is really fugly", "is horrible", "sux", "gonna suck on a lemon", "is so stupid", "is lamer", "is lame", "is l33tr", "totally lit", "is a waste of space", "is awful" };
